...
# Score
setting_data = open('dino/High_Score.txt', 'r')
...
surface = pygame.image.load('dino/icon.png')
pygame.display.set_icon(surface)

jump_sound = pygame.mixer.Sound('dino/jump.wav')
die_sound = pygame.mixer.Sound('dino/die.wav')
checkPoint_sound = pygame.mixer.Sound('dino/checkPoint.wav')
...
def load_sprite_sheet(
    ...
    fullname = os.path.join('dino', s_name)
            ...
            for c in cactusan:
                ...
                if pygame.sprite.collide_mask(gamer_Dino,c):
                    ...
                    if pygame.mixer.get_init() != None:
                        ...
                        with open('dino/High_Score.txt', 'w') as f:
                            highScore.update(highest_scores)
                            f.write('0')
